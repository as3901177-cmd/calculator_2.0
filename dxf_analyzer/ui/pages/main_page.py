...
def _process_file(uploaded_file):
    ...
    with st.spinner('⏳ Обработка чертежа...'):
        try:
            ...
            # ================= УДАЛЁН ВЫЗОВ _run_nfp_debug =================
            # Раньше здесь был вызов отладочного блока, теперь анализ
            # будет автоматически выполняться при запуске раскроя (в логах)
...
# ==================== ФУНКЦИЯ _run_nfp_debug УДАЛЕНА ПОЛНОСТЬЮ ====================
